...
import { AnyField } from './models/metadata-builders';

@Directive()
export abstract class BaseCtrl<T extends AnyField>
  implements OnInit, OnDestroy
{
  ...
  set field(field: T) {
    ...
    this.formControl.patchValue(field._metadata._initialValue, {
      emitEvent: true,
    });
  ...
  abstract getValue(): T['_metadata']['__optionalOutputType'];
